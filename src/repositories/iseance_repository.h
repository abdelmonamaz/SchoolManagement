...
public:
    ...
    // Bulletin: get all exam séances for a class in a specific year (bypasses active-year filter)
    virtual Result<QList<Seance>> getByClasseIdAndYear(int classeId, int anneeId) = 0;
